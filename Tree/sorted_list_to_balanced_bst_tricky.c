// Point to note is that when recursion comes back to main loop, the left sub tree is built 
// and root is middle node. Now it's up to 2nd recursion to build the right sub tree.
